...
public class PeopleModel implements Serializable {
    ...
    @Length(max = 200, message = "籍贯市最大长度为200位")
    ...
    @Length(max = 200, message = "籍贯区/县最大长度为200位")
    ...
    @Length(max = 200, message = "籍贯详细地址最大长度为200位")
    ...
    @Length(max = 200, message = "现住省最大长度为200位")
    ...
    @Length(max = 200, message = "现住市最大长度为200位")
    ...
    @Length(max = 200, message = "现住区/县最大长度为200位")
    ...
    @Length(max = 200, message = "现住详细地址最大长度为200位")
